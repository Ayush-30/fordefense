...
!(function (e, t) {
  ...
  var h = (function (n) {
    ...
    function oe(e, t, n, i) {
      ...
      if (
        !i &&
        ((t ? t.ownerDocument || t : y) !== E && C(t), (t = t || E), T)
      ) {
        if (11 !== d && (l = G.exec(e)))
          if ((r = l[1])) {
            if (9 === d) {
      ...
      function (e) {
        ...
        return (
          i !== E &&
            ...
            (h.getElementsByClassName = V.test(E.getElementsByClassName)),
            (h.getById = le(function (e) {
              return (
                (s.appendChild(e).id = x),
                !E.getElementsByName || !E.getElementsByName(x).length
              );
            })),
            h.getById
            ...
            (a = []),
            (g = []),
            (h.qsa = V.test(E.querySelectorAll)) &&
              (le(function (e) {
    ...
    (oe.contains = function (e, t) {
      return (e.ownerDocument || e) !== E && C(e), v(e, t);
    }),
      ...
      return (
        ...
        ae(function (e, t, n, i) {
          var r,
            ...
            d = m ? (v || (e ? h : c || g) ? [] : t) : f;
          if ((m && m(f, d, n, i), g))
            for (r = _e(d, l), g(r, [], n, i), o = r.length; o--; )
              (s = r[o]) && (d[l[o]] = !(f[l[o]] = s));
          if (e) {
            if (v || h) {
              if (v) {
    ...
    return (
            ...
            (s = I(
              ...
              (i = function (e, t, n, i, r) {
                ...
                for (
                  ...
                  if (b && o) {
                    for (
                      s = 0, t || o.ownerDocument === E || (C(o), (n = !T));
                      (a = g[s++]);
        ...
        function (e, t, n, i) {
          ...
          if (((n = n || []), 1 === u.length)) {
            if (
              ...
              if (!(t = (_.find.ID(s.matches[0].replace(J, ee), t) || [])[0]))
                return n;
            ...
            for (
              ...
              if (
                ...
                (i = l(
                  ...
                  (Z.test(o[0].type) && me(t.parentNode)) || t
                ))
              ) {
      ...
      (h.sortStable = x.split("").sort(A).join("") === x),
  ...
  (x.filter = function (e, t, n) {
    ...
    x.fn.extend({
      ...
      is: function (e) {
        return !!D(this, "string" == typeof e && S.test(e) ? x(e) : e || [], !1)
          .length;
      },
    });
  var k,
      ...
      function (i, r) {
        x.fn[i] = function (e, t) {
          ...
          return (
            ...
            1 < this.length &&
              (L[i] || x.uniqueSort(n), O.test(i) && n.reverse()),
            this.pushStack(n)
          );
        };
      }
        ...
        var o = [
          ...
          s = {
            ...
            then: function (t, n, i) {
                    ...
                    e = function () {
                      ...
                      if (!(r < l)) {
                        ...
                        (t =
                          ...
                          y(t)
                            ? a
                              ? t.call(e, c(l, o, H, a), c(l, o, R, a))
                              : (l++,
                                t.call(
                                  e,
                                  c(l, o, H, a),
                                  c(l, o, R, a),
                                  c(l, o, H, o.notifyWith)
                                ))
                            : (s !== H && ((n = void 0), (i = [e])),
                              (a || o.resolveWith)(n, i));
                      }
              ...
              return x
                .Deferred(function (e) {
                  o[0][3].add(c(0, e, y(i) ? i : H, e.notifyWith)),
                    o[1][3].add(c(0, e, y(t) ? t : H)),
                    o[2][3].add(c(0, e, y(n) ? n : R));
                })
                .promise();
            },
            promise: function (e) {
  ...
  function ve(e, t, n, i, r) {
    ...
    for (f.textContent = "", h = 0; (o = d[h++]); )
      if (i && -1 < x.inArray(o, i)) r && r.push(o);
        ...
        ((c = x.contains(o.ownerDocument, o)),
  ...
  function je(n, i, r, o) {
    ...
    if (
      ...
      for (a = (s = x.map(de(e, "script"), Ne)).length; u < f; u++)
        (l = e),
          u !== d &&
            ((l = x.clone(l, !0, !0)), a && x.merge(s, de(l, "script"))),
          r.call(n[u], l, u);
      if (a)
        for (c = s[s.length - 1].ownerDocument, x.map(s, Oe), u = 0; u < a; u++)
          (l = s[u]),
            ue.test(l.type || "") &&
              ...
              (l.src && "module" !== (l.type || "").toLowerCase()
                ...
                : _(l.textContent.replace(De, ""), c, l));
    }
    return n;
  }
  function Pe(e, t, n) {
    for (var i, r = t ? x.filter(t, e) : e, o = 0; null != (i = r[o]); o++)
      n || 1 !== i.nodeType || x.cleanData(de(i)),
        i.parentNode &&
          (n && x.contains(i.ownerDocument, i) && he(de(i, "script")),
  ...
  x.extend({
    ...
    clone: function (e, t, n) {
      ...
      return (
        0 < (s = de(u, "script")).length && he(s, !f && de(e, "script")), u
      );
    },
          ...
          function (e) {
            ...
            if (
              ...
              try {
                for (; n < i; n++)
                  1 === (t = this[n] || {}).nodeType &&
                    (x.cleanData(de(t, !1)), (t.innerHTML = e));
                t = 0;
              } catch (e) {}
            }
      ...
      replaceWith: function () {
        ...
        return je(
          ...
          function (e) {
            ...
            x.inArray(this, n) < 0 &&
              (x.cleanData(de(this)), t && t.replaceChild(e, this));
          },
          n
        );
      },
  ...
  function Ve(e, t, n) {
    ...
    return (
      ...
      (r = parseFloat(r) || 0) +
        Qe(e, t, n || (o ? "border" : "content"), s, i, r) +
        "px"
    );
  }
  ...
  x.extend({
    ...
    style: function (e, t, n, i) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var r,
          ...
          c = e.style;
        if (
          (l || (t = ze(a)), (s = x.cssHooks[t] || x.cssHooks[a]), void 0 === n)
        )
    ...
    x.each({ margin: "", padding: "", border: "Width" }, function (r, o) {
      (x.cssHooks[r + o] = {
        ...
        "margin" !== r && (x.cssHooks[r + o].set = Ke);
    }),
    x.fn.extend({
      css: function (e, t) {
        return X(
  ...
  function lt(o, e, t) {
    ...
    for (
      ...
      if ((n = lt.prefilters[i].call(c, o, u, c.opts)))
        return (
          y(n.stop) &&
        ...
        if ((l = !x.isEmptyObject(t)) || !x.isEmptyObject(h))
          ...
          h))
            l ||
              ...
              m && ae([e], !0),
              d.done(function () {
                for (i in (m || ae([e]), Q.remove(e, "fxshow"), h))
                  x.style(e, i, h[i]);
              })),
              (l = at(m ? g[i] : 0, i, d)),
              i in g ||
    ...
    x.fn.extend({
      ...
      toggleClass: function (r, t) {
        ...
        return "boolean" == typeof t && s
          ...
          : this.each(function () {
              var e, t, n, i;
              if (s)
                for (t = 0, n = x(this), i = mt(r); (e = i[t++]); )
                  n.hasClass(e) ? n.removeClass(e) : n.addClass(e);
              else
                (void 0 !== r && "boolean" !== o) ||
                  ((e = pt(this)) && Q.set(this, "__className__", e),
                  this.setAttribute &&
                    this.setAttribute(
                      "class",
      ...
      hasClass: function (e) {
        var t,
          ...
          i = 0;
        for (t = " " + e + " "; (n = this[i++]); )
          if (1 === n.nodeType && -1 < (" " + ht(pt(n)) + " ").indexOf(t))
            return !0;
        return !1;
      },
    });
  ...
  x.extend(x.event, {
    trigger: function (e, t, n, i) {
      ...
      if (
        ...
        3 !== n.nodeType &&
          8 !== n.nodeType &&
          !vt.test(h + x.event.triggered) &&
          (-1 < h.indexOf(".") && ((h = (p = h.split(".")).shift()), p.sort()),
          (l = h.indexOf(":") < 0 && "on" + h),
          ((e = e[x.expando]
            ? e
            : new x.Event(h, "object" == typeof e && e)).isTrigger = i ? 2 : 3),
          (e.namespace = p.join(".")),
        ...
        if (!i && !u.noBubble && !b(n)) {
          for (
            a = u.delegateType || h, vt.test(a + h) || (o = o.parentNode);
            o;
            o = o.parentNode
          )
            d.push(o), (s = o);
        ...
        for (r = 0; (o = d[r++]) && !e.isPropagationStopped(); )
          (f = o),
            ...
            (c = (Q.get(o, "events") || {})[e.type] && Q.get(o, "handle")) &&
              c.apply(o, t),
            (c = l && o[l]) &&
              c.apply &&
              z(o) &&
        ...
        return (
          ...
          i ||
            ...
            (l &&
              ...
              ((s = n[l]) && (n[l] = null),
              (x.event.triggered = h),
              e.isPropagationStopped() && f.addEventListener(h, yt),
              n[h](),
              e.isPropagationStopped() && f.removeEventListener(h, yt),
  ...
  (Ht.href = bt.href),
    x.extend({
      ...
      ajax: function (e, t) {
        ...
        g.ifModified &&
          (x.lastModified[f] &&
            C.setRequestHeader("If-Modified-Since", x.lastModified[f]),
          x.etag[f] && C.setRequestHeader("If-None-Match", x.etag[f])),
        ...
        function c(e, t, n, i) {
          ...
          p ||
            ...
            r
              ? (g.ifModified &&
                  ((l = C.getResponseHeader("Last-Modified")) &&
                    (x.lastModified[f] = l),
                  (l = C.getResponseHeader("etag")) && (x.etag[f] = l)),
                204 === e || "HEAD" === g.type
                  ? (c = "nocontent")
                  : 304 === e
                  ? (c = "notmodified")
            ...
            (C.status = e),
            (C.statusText = (t || c) + ""),
            r ? b.resolveWith(v, [o, c, C]) : b.rejectWith(v, [C, c, s]),
            C.statusCode(w),
            (w = void 0),
  ...
  x.ajaxSetup({
    ...
    x.each(["top", "left"], function (e, n) {
      x.cssHooks[n] = qe(v.pixelPosition, function (e, t) {
        if (t)
  ...
  return (
    (x.noConflict = function (e) {
      return E.$ === x && (E.$ = Ut), e && E.jQuery === x && (E.jQuery = Ft), x;
    }),
    e || (E.jQuery = E.$ = x),
    x
  );
  ...
  (t = function (e, p, f) {
      ...
      H = (function () {
        ...
        return (
          ...
          (e._getConfig = function (e) {
            return (e = l({}, A, e)), m.typeCheckConfig(E, e, D), e;
          }),
          ...
          (e._addTouchEventListeners = function () {
            ...
            if (this._touchSupported) {
              ...
              p(this._element.querySelectorAll(".carousel-item img")).on(
                ...
                this._pointerEvent
                  ? (p(this._element).on(O.POINTERDOWN, function (e) {
                      return t(e);
                    }),
                  ...
                  : (p(this._element).on(O.TOUCHSTART, function (e) {
                      return t(e);
                    }),
    ...
    p(document).on(
      ...
      (p.fn[E].noConflict = function () {
        return (p.fn[E] = I), H._jQueryInterface;
      });
    var R = "collapse",
      W = "bs.collapse",
      M = "." + W,
      ...
      Q = (function () {
        ...
        return (
            ...
            if (
              !(
                ...
                (this._parent &&
                  ...
                  (e = null),
                e &&
                  (t = p(e).not(this._selector).data(W)) &&
                  t._isTransitioning)
              )
            ) {
              ...
              if ((p(this._element).trigger(i), !i.isDefaultPrevented())) {
                ...
                p(this._element).removeClass(F).addClass(U),
                ...
                p(this._element)
                  .one(m.TRANSITION_END, function () {
                    p(n._element).removeClass(U).addClass(F).addClass($),
                      (n._element.style[r] = ""),
            ...
            if (!this._isTransitioning && p(this._element).hasClass($)) {
              ...
              if ((p(this._element).trigger(t), !t.isDefaultPrevented())) {
                ...
                (this._element.style[n] =
                  ...
                  p(this._element).addClass(U).removeClass(F).removeClass($);
          ...
          (e._getConfig = function (e) {
            return (
              ((e = l({}, Y, e)).toggle = Boolean(e.toggle)),
              m.typeCheckConfig(R, e, X),
              e
            );
          }),
    ...
    p(document).on(B.CLICK_DATA_API, K, function (e) {
      ...
      (p.fn[R] = Q._jQueryInterface),
      (p.fn[R].Constructor = Q),
      (p.fn[R].noConflict = function () {
        return (p.fn[R] = q), Q._jQueryInterface;
      });
    var V = "dropdown",
      G = "bs.dropdown",
      Z = "." + G,
        ...
        return (
              ...
              if ((c._clearMenus(), !t)) {
                ...
                if ((p(e).trigger(i), !i.isDefaultPrevented())) {
                  ...
                  "ontouchstart" in document.documentElement &&
                    ...
                    p(e).toggleClass(re).trigger(p.Event(ne.SHOWN, n));
                }
              }
            }
          }),
            ...
            if (
              ...
              p(n).trigger(t),
                t.isDefaultPrevented() ||
                  (p(this._menu).toggleClass(re),
                  p(n).toggleClass(re).trigger(p.Event(ne.SHOWN, e)));
            }
          }),
          (e.hide = function () {
            if (
              ...
              p(n).trigger(t),
                t.isDefaultPrevented() ||
                  (p(this._menu).toggleClass(re),
                  p(n).toggleClass(re).trigger(p.Event(ne.HIDDEN, e)));
            }
          }),
          (e.dispose = function () {
            p.removeData(this._element, G),
              p(this._element).off(Z),
              (this._element = null),
          ...
          (e._getConfig = function (e) {
            return (
              ...
              m.typeCheckConfig(V, e, this.constructor.DefaultType),
              e
            );
          }),
          ...
          (e._getPlacement = function () {
            ...
            return (
              e.hasClass("dropup")
                ...
                : e.hasClass("dropleft")
                ? (t = "left-start")
                : p(this._menu).hasClass(oe) && (t = "bottom-end"),
              t
            );
          }),
                  ...
                  if (
                    ...
                    p(r).trigger(l),
                      l.isDefaultPrevented() ||
                        ...
                        p(a).removeClass(re),
                        p(r).removeClass(re).trigger(p.Event(ne.HIDDEN, s)));
                  }
                }
              }
          }),
          ...
          (c._dataApiKeydownHandler = function (e) {
            if (
              ...
              (e.preventDefault(),
              e.stopPropagation(),
              !this.disabled && !p(this).hasClass(ie))
            ) {
    ...
    p(document)
      .on(ne.KEYDOWN_DATA_API, se, ue._dataApiKeydownHandler)
      ...
      .on(ne.CLICK_DATA_API, se, function (e) {
        e.preventDefault(),
          e.stopPropagation(),
          ue._jQueryInterface.call(p(this), "toggle");
      })
      .on(ne.CLICK_DATA_API, ".dropdown form", function (e) {
        e.stopPropagation();
      }),
      (p.fn[V] = ue._jQueryInterface),
      (p.fn[V].Constructor = ue),
    ...
    var fe = "modal",
      ...
      Ee = (function () {
        function r(e, t) {
          (this._config = this._getConfig(t)),
            (this._element = e),
            (this._dialog = e.querySelector(".modal1-dialog")),
            (this._backdrop = null),
            (this._isShown = !1),
        ...
        return (
            ...
            if (
              ...
              if (
                ...
                if (
                  ...
                  p(this._element).removeClass(_e),
          ...
          (e._getConfig = function (e) {
            return (e = l({}, me, e)), m.typeCheckConfig(fe, e, ge), e;
          }),
          (e._showElement = function (e) {
            ...
            (this._element.parentNode &&
              ...
              p(this._dialog).hasClass("modal-dialog-scrollable")
                ? (this._dialog.querySelector(".modal1-body").scrollTop = 0)
                : (this._element.scrollTop = 0),
              n && m.reflow(this._element),
              p(this._element).addClass(_e),
          ...
          (e._setEscapeEvent = function () {
            ...
            this._isShown && this._config.keyboard
              ? p(this._element).on(ve.KEYDOWN_DISMISS, function (e) {
          ...
          (e._showBackdrop = function (e) {
            ...
            if (this._isShown && this._config.backdrop) {
              if (
                ...
                p(this._element).on(ve.CLICK_DISMISS, function (e) {
          ...
          (r._jQueryInterface = function (n, i) {
            return this.each(function () {
              ...
              if (
                (e || ((e = new r(this, t)), p(this).data(de, e)),
                "string" == typeof n)
              ) {
                if (void 0 === e[n])
                  throw new TypeError('No method named "' + n + '"');
    ...
    p(document).on(ve.CLICK_DATA_API, '[data-toggle="modal"]', function (e) {
      ...
      (p.fn[fe] = Ee._jQueryInterface),
      (p.fn[fe].Constructor = Ee),
      (p.fn[fe].noConflict = function () {
        return (p.fn[fe] = pe), Ee._jQueryInterface;
      });
    var Te = [
        "background",
        "cite",
            ...
            r.forEach(function (e) {
              (function (e, t) {
                ...
                if (-1 !== t.indexOf(n))
                  return (
                    -1 === Te.indexOf(n) ||
                    Boolean(e.nodeValue.match(xe) || e.nodeValue.match(Se))
                  );
                for (
        ...
        return (
          ...
          (e.toggle = function (e) {
            if (this._isEnabled)
              if (e) {
                ...
                if (p(this.getTipElement()).hasClass(Ye))
          ...
          (e.dispose = function () {
            clearTimeout(this._timeout),
              ...
              p(this.element).closest(".modal1").off("hide.bs.modal1"),
          ...
          (e.show = function () {
            ...
            if (this.isWithContent() && this._isEnabled) {
              ...
              r.setAttribute("id", o),
                ...
                this.setContent(),
                this.config.animation && p(r).addClass(qe);
              var s =
          ...
          (e.setContent = function () {
            ...
            this.setElementContent(
              ...
              p(e).removeClass(qe + " " + Ye);
          }),
          (e.setElementContent = function (e, t) {
            "object" != typeof t || (!t.nodeType && !t.jquery)
              ? this.config.html
                ? (this.config.sanitize &&
                    (t = Ie(t, this.config.whiteList, this.config.sanitizeFn)),
                  e.html(t))
                : e.text(t)
              : this.config.html
          ...
          (e._enter = function (e, t) {
            ...
            (t = t || p(e.currentTarget).data(n)) ||
              ...
              e && (t._activeTrigger["focusin" === e.type ? Be : Xe] = !0),
              p(t.getTipElement()).hasClass(Ye) || t._hoverState === We
                ? (t._hoverState = We)
          ...
          (e._leave = function (e, t) {
            ...
            (t = t || p(e.currentTarget).data(n)) ||
              ...
              p(e.currentTarget).data(n, t)),
              e && (t._activeTrigger["focusout" === e.type ? Be : Xe] = !1),
          ...
          (e._getConfig = function (e) {
            ...
            return (
              ...
              e.sanitize &&
                (e.template = Ie(e.template, e.whiteList, e.sanitizeFn)),
              e
            );
          }),
          ...
          (i._jQueryInterface = function (n) {
            return this.each(function () {
              ...
              if (
                ...
                (e || ((e = new i(this, t)), p(this).data(De, e)),
                "string" == typeof n)
              ) {
                if (void 0 === e[n])
                  throw new TypeError('No method named "' + n + '"');
    ...
    (p.fn[Ae] = $e._jQueryInterface),
      (p.fn[Ae].Constructor = $e),
      (p.fn[Ae].noConflict = function () {
        return (p.fn[Ae] = Ne), $e._jQueryInterface;
      });
    var Fe = "popover",
      Ue = "bs.popover",
      ze = "." + Ue,
      ...
      et = (function (e) {
        ...
        return (
          ...
          (r.addAttachmentClass = function (e) {
            p(this.getTipElement()).addClass(Qe + "-" + e);
          }),
          ...
          (i._jQueryInterface = function (n) {
            return this.each(function () {
              ...
              if (
                (e || !/dispose|hide/.test(n)) &&
                (e || ((e = new i(this, t)), p(this).data(Ue, e)),
                "string" == typeof n)
              ) {
                if (void 0 === e[n])
                  throw new TypeError('No method named "' + n + '"');
    ...
    (p.fn[Fe] = et._jQueryInterface),
      (p.fn[Fe].Constructor = et),
      (p.fn[Fe].noConflict = function () {
        return (p.fn[Fe] = Ke), et._jQueryInterface;
      });
    var tt = "scrollspy",
      nt = "bs.scrollspy",
      it = "." + nt,
      ...
      ht = (function () {
        ...
        return (
          ...
          (e._getConfig = function (e) {
            if (
              "string" !=
              typeof (e = l({}, ot, "object" == typeof e && e ? e : {})).target
            ) {
              var t = p(e.target).attr("id");
              t || ((t = m.getUID(tt)), p(e.target).attr("id", t)),
                (e.target = "#" + t);
            }
          ...
          (e._activate = function (t) {
            ...
            n.hasClass("dropdown-item")
              ? (n.closest(".dropdown").find(".dropdown-toggle").addClass(lt),
                n.addClass(lt))
              : (n.addClass(lt),
                n
                  .parents(ct)
                  .prev(ut + ", " + ft)
                  .addClass(lt),
                n.parents(ct).prev(".nav-item").children(ut).addClass(lt)),
              p(this._scrollElement).trigger(at.ACTIVATE, { relatedTarget: t });
          }),
          (e._clear = function () {
            [].slice
              .call(document.querySelectorAll(this._selector))
          ...
          (i._jQueryInterface = function (n) {
            return this.each(function () {
              var e = p(this),
                t = e.data(pt);
              if (
                (t || ((t = new i(this)), e.data(pt, t)), "string" == typeof n)
              ) {
                if (void 0 === t[n])
                  throw new TypeError('No method named "' + n + '"');
                t[n]();
        ...
        return (
          ...
          (e._getConfig = function (e) {
            return (
              ...
              m.typeCheckConfig(Ct, e, this.constructor.DefaultType),
              e
            );
          }),
          (e._setListeners = function () {
          ...
          (i._jQueryInterface = function (n) {
            return this.each(function () {
              ...
              if (
                (t ||
                  ((t = new i(this, "object" == typeof n && n)), e.data(Et, t)),
                "string" == typeof n)
              ) {
                if (void 0 === t[n])
                  throw new TypeError('No method named "' + n + '"');
    ...
    (p.fn[Ct] = Nt._jQueryInterface),
      (p.fn[Ct].Constructor = Nt),
      (p.fn[Ct].noConflict = function () {
        return (p.fn[Ct] = xt), Nt._jQueryInterface;
      }),
      (function () {
        if (void 0 === p)
          throw new TypeError(
  ...
  (n = function (u) {
    var f,
      ...
      _ = function (e, t, n, i) {
        ...
        return (
          (r.className = "mfp-" + e),
          n && (r.innerHTML = n),
          i ? t && t.appendChild(r) : ((r = u(r)), t && r.appendTo(t)),
          r
        );
      },
      w = function (e, t) {
        f.ev.triggerHandler("mfp" + e, t),
          f.st.callbacks &&
            ...
            f.st.callbacks[e] &&
              f.st.callbacks[e].apply(f, u.isArray(t) ? t : [t]));
      },
      C = function (e) {
        return (
          (e === t && f.currTemplate.closeBtn) ||
            ((f.currTemplate.closeBtn = u(
      ...
      o = function () {
        u.magnificPopup.instance ||
          ((f = new e()).init(), (u.magnificPopup.instance = f));
      };
    (e.prototype = {
      constructor: e,
      init: function () {
      ...
      open: function (e) {
        ...
        if (!1 === e.isObj) {
          ...
          (f.items = u.isArray(e.items) ? e.items : [e.items]),
            (f.index = e.index || 0);
        if (!f.isOpen) {
          (f.types = []),
            (h = ""),
            e.mainEl && e.mainEl.length ? (f.ev = e.mainEl.eq(0)) : (f.ev = d),
            e.key
              ? (f.popupsCache[e.key] || (f.popupsCache[e.key] = {}),
                (f.currTemplate = f.popupsCache[e.key]))
              : (f.currTemplate = {}),
            (f.st = u.extend(!0, {}, u.magnificPopup.defaults, e)),
            (f.fixedContentPos =
            ...
            f.bgOverlay ||
              ((f.bgOverlay = _("bg").on("click" + g, function () {
                f.close();
              })),
              (f.wrap = _("wrap")
                .attr("tabindex", -1)
              ...
              (f.container = _("container", f.wrap))),
            (f.contentContainer = _("content")),
            f.st.preloader &&
              (f.preloader = _("preloader", f.container, f.st.tLoading));
          ...
          return (
            ...
            f.bgOverlay
              .add(f.wrap)
              .prependTo(f.st.prependTo || u(document.body)),
      ...
      updateItemHTML: function () {
        ...
        var t = e.type;
        if (
          (w("BeforeChange", [f.currItem ? f.currItem.type : "", t]),
          (f.currItem = e),
          !f.currTemplate[t])
        ) {
        ...
        var i = f["get" + t.charAt(0).toUpperCase() + t.slice(1)](
          e,
          f.currTemplate[t]
        );
        f.appendContent(i, t),
      ...
      _checkIfClose: function (e) {
        if (!u(e).hasClass(s)) {
          ...
          if (
            ...
            return !0;
          if (e === f.content[0] || u.contains(f.content[0], e)) {
            if (t) return !0;
      ...
      _onFocusIn: function (e) {
        return e.target === f.wrap[0] || u.contains(f.wrap[0], e.target)
          ? void 0
          : (f._setFocus(), !1);
      },
              ...
              if (0 < n.length) {
                ...
                "replaceWith" === i
                  ...
                  ? n.is("img")
                    ? n.attr("src", t)
                    : n.replaceWith(
                        u("<img>").attr("src", t).attr("class", n.attr("class"))
                      )
                  : n.attr(o[1], t);
              }
        ...
        getInline: function (e, t) {
          if ((I(), e.src)) {
            ...
            if (i.length) {
              ...
              r &&
                r.tagName &&
                (T || ((E = n.hiddenClass), (T = _(E)), (E = "mfp-" + E)),
                (x = i.after(T).detach().removeClass(E))),
        ...
        getImage: function (e, t) {
          ...
          if (s.length) {
            ...
            (a.className = "mfp-img"),
              ...
              (e.img = u(a).on("load.mfploader", i).on("error.mfploader", r)),
              (a.src = e.src),
            ...
            f._parseMarkup(
              t,
              {
                title: (function (e) {
                  ...
                  if (t) {
                    if (u.isFunction(t)) return t.call(f, e);
    ...
    u.magnificPopup.registerModule("gallery", {
      ...
      proto: {
          ...
          return (
            ...
            !(!o || !o.enabled) &&
              ...
              b("UpdateStatus" + e, function (e, t) {
                t.text &&
                  (t.text = R(t.text, f.currItem.index, f.items.length));
              }),
        ...
        next: function () {
          (f.direction = !0), (f.index = H(f.index + 1)), f.updateItemHTML();
        },
        prev: function () {
          (f.direction = !1), (f.index = H(f.index - 1)), f.updateItemHTML();
        },
        goTo: function (e) {
        ...
        preloadNearbyImages: function () {
          var e,
            t = f.st.gallery.preload,
            n = Math.min(t[0], f.items.length),
            i = Math.min(t[1], f.items.length);
          for (e = 1; e <= (f.direction ? i : n); e++)
            f._preloadItem(f.index + e);
          for (e = 1; e <= (f.direction ? n : i); e++)
            f._preloadItem(f.index - e);
        },
        _preloadItem: function (e) {
          if (((e = H(e)), !f.items[e].preloaded)) {
            var t = f.items[e];
            t.parsed || (t = f.parseEl(e)),
              w("LazyLoad", t),
              "image" === t.type &&
        ...
        function (e, t, n) {
          ...
          (n.add = function (e, t) {
            ...
            e.classList
              ? e.classList.add(t)
              : ((i = t),
                (r = (n = e).className.split(" ")).indexOf(i) < 0 && r.push(i),
                (n.className = r.join(" ")));
          }),
            (n.remove = function (e, t) {
              ...
              e.classList
                ...
                : ((i = t),
                  (r = (n = e).className.split(" ")),
                  0 <= (o = r.indexOf(i)) && r.splice(o, 1),
                  (n.className = r.join(" ")));
            }),
            (n.list = function (e) {
              return e.classList
          ...
          (i.e = function (e, t) {
            ...
            (i.css = function (e, t, n) {
              return "object" == typeof t
                ...
                : void 0 === n
                ? ((s = e), (a = t), window.getComputedStyle(s)[a])
                : ((i = e),
                  (r = t),
        ...
        function (e, t, n) {
          ...
          (n.toInt = function (e) {
            ...
            (n.outerWidth = function (e) {
              return (
                this.toInt(i.css(e, "width")) +
                this.toInt(i.css(e, "paddingLeft")) +
                this.toInt(i.css(e, "paddingRight")) +
                this.toInt(i.css(e, "borderLeftWidth")) +
                this.toInt(i.css(e, "borderRightWidth"))
              );
            }),
            (n.startScrolling = function (e, t) {
              r.add(e, "ps-in-scrolling"),
                void 0 !== t
                  ? r.add(e, "ps-" + t)
                  : (r.add(e, "ps-x"), r.add(e, "ps-y"));
            }),
            (n.stopScrolling = function (e, t) {
              r.remove(e, "ps-in-scrolling"),
                void 0 !== t
                  ? r.remove(e, "ps-" + t)
                  : (r.remove(e, "ps-x"), r.remove(e, "ps-y"));
            }),
            (n.env = {
        ...
        function (e, t, n) {
          ...
          t.exports = function (e) {
            !(function (i, r) {
              ...
              r.settings.stopPropagationOnClick &&
                  ...
                  var t = s.toInt(r.scrollbarYHeight / 2),
                    n =
                      (r.railYRatio *
                        (e.pageY -
                          window.pageYOffset -
                          o(r.scrollbarYRail).top -
                          t)) /
                      (r.railYRatio * (r.railYHeight - r.scrollbarYHeight));
                  n < 0 ? (n = 0) : 1 < n && (n = 1),
                    l(i, "top", (r.contentHeight - r.containerHeight) * n),
                    a(i),
                    e.stopPropagation();
                }),
                r.settings.stopPropagationOnClick &&
                  ...
                  var t = s.toInt(r.scrollbarXWidth / 2),
                    n =
                      (r.railXRatio *
                        (e.pageX -
                          window.pageXOffset -
                          o(r.scrollbarXRail).left -
                          t)) /
                      (r.railXRatio * (r.railXWidth - r.scrollbarXWidth));
                  n < 0 ? (n = 0) : 1 < n && (n = 1),
                    l(
                      i,
                      "left",
                      (r.contentWidth - r.containerWidth) * n -
        ...
        function (e, t, n) {
          ...
          function r(r, o) {
            ...
            o.event.bind(o.scrollbarX, "mousedown", function (e) {
              (t = e.pageX),
                (s = l.toInt(a.css(o.scrollbarX, "left")) * o.railXRatio),
          ...
          function o(r, o) {
            ...
            o.event.bind(o.scrollbarY, "mousedown", function (e) {
              (t = e.pageY),
                (s = l.toInt(a.css(o.scrollbarY, "top")) * o.railYRatio),
                  ...
                  f(o, "top", o.scrollTop - r),
                    ...
                    (function (e, t) {
                      ...
                      if (0 === e) {
                        ...
                        if (
                          (0 === n && 0 < t) ||
                          (n >= s.contentHeight - s.containerHeight && t < 0)
                        )
                      ...
                      if (0 === t) {
                        ...
                        if (
                          (0 === i && e < 0) ||
                          (i >= s.contentWidth - s.containerWidth && 0 < e)
                        )
                          return !s.settings.wheelPropagation;
                      }
                      return !0;
        ...
        function (e, t, n) {
          ...
          function r(a, l) {
            ...
            function e(e) {
              var t,
                ...
                r =
                  ...
                  (i = -1 * t.deltaY),
                  (void 0 !== n && void 0 !== i) ||
                    ((n = (-1 * t.wheelDeltaX) / 6), (i = t.wheelDeltaY / 6)),
                  t.deltaMode && 1 === t.deltaMode && ((n *= 10), (i *= 10)),
                  n != n && i != i && ((n = 0), (i = t.wheelDelta)),
                  [n, i]),
                o = r[0],
                s = r[1];
              (function (e, t) {
                var n = a.querySelector("textarea:hover");
                if (n) {
                  ...
                  ? l.scrollbarYActive && !l.scrollbarXActive
                    ? (f(
                        ...
                        s
                          ...
                          : a.scrollTop + o * l.settings.wheelSpeed
                      ),
                      (c = !0))
                    : l.scrollbarXActive &&
                      !l.scrollbarYActive &&
                      (f(
                        ...
                        "left",
                        o
                          ? a.scrollLeft + o * l.settings.wheelSpeed
                          : a.scrollLeft - s * l.settings.wheelSpeed
                      ),
                      (c = !0))
                  : (f(a, "top", a.scrollTop - s * l.settings.wheelSpeed),
                    f(a, "left", a.scrollLeft + o * l.settings.wheelSpeed)),
                u(a),
                (c =
                  c ||
                  (function (e, t) {
                    ...
                    if (0 === t) {
                      ...
                      if (
                        (0 === i && e < 0) ||
                        (i >= l.contentWidth - l.containerWidth && 0 < e)
                      )
                        return !l.settings.wheelPropagation;
                    }
                    return !0;
            ...
            void 0 !== window.onwheel
              ? l.event.bind(a, "wheel", e)
              : void 0 !== window.onmousewheel &&
                l.event.bind(a, "mousewheel", e);
          }
          t.exports = function (e) {
            r(e, i.get(e));
          };
                    ...
                    0 === c.top && 0 === c.left
                      ...
                      : l ||
                        (l = setInterval(function () {
                          h.get(a)
                            ? (m(a, "top", a.scrollTop + c.top),
                              m(a, "left", a.scrollLeft + c.left),
                              p(a))
                            : clearInterval(l);
                        }, 50));
                }
                ...
                0 < s && ((d.x = i / s), (d.y = r / s), (f = o)),
                  (function (e, t) {
                    ...
                    if (r < o) {
                      ...
                      o < r &&
                      ((e < 0 && i === l.contentWidth - l.containerWidth) ||
                        (0 < e && 0 === i))
                    )
                      return !l.settings.swipePropagation;
                    return !0;
                ...
                (n = setInterval(function () {
                  y.get(a)
                    ? Math.abs(d.x) < 0.01 && Math.abs(d.y) < 0.01
                      ? clearInterval(n)
                      : (c(30 * d.x, 30 * d.y), (d.x *= 0.8), (d.y *= 0.8))
                    : clearInterval(n);
                }, 10)));
            }
            e &&
              (l.event.bind(window, "touchstart", i),
              l.event.bind(window, "touchend", r),
              l.event.bind(a, "touchstart", o),
              l.event.bind(a, "touchmove", s),
              l.event.bind(a, "touchend", v)),
              t &&
                (window.PointerEvent
                  ? (l.event.bind(window, "pointerdown", i),
                    l.event.bind(window, "pointerup", r),
                    l.event.bind(a, "pointerdown", o),
                    l.event.bind(a, "pointermove", s),
                    l.event.bind(a, "pointerup", v))
                  : window.MSPointerEvent &&
                    (l.event.bind(window, "MSPointerDown", i),
                    l.event.bind(window, "MSPointerUp", r),
                    l.event.bind(a, "MSPointerDown", o),
                    l.event.bind(a, "MSPointerMove", s),
        ...
        function (e, t, n) {
          ...
          t.exports = function (e, t) {
            ...
            (n.settings = r.extend(n.settings, t)),
              ...
              u(e),
              f(e),
              n.settings.useSelectionScroll && d(e),
              (r.env.supportsTouch || r.env.supportsIePointer) &&
                h(e, r.env.supportsTouch, r.env.supportsIePointer),
        ...
        function (e, t, n) {
          ...
          function f(e) {
            ...
            (i.settings = u.clone(l)),
              ...
              (i.scrollbarXRail = a.appendTo(
                a.e("div", "ps-scrollbar-x-rail"),
                e
              )),
              (i.scrollbarX = a.appendTo(
              ...
              (i.scrollbarXBottom = u.toInt(a.css(i.scrollbarXRail, "bottom"))),
              (i.isScrollbarXUsingBottom =
                i.scrollbarXBottom == i.scrollbarXBottom),
              (i.scrollbarXTop = i.isScrollbarXUsingBottom
                ? null
                : u.toInt(a.css(i.scrollbarXRail, "top"))),
              (i.railBorderXWidth =
                u.toInt(a.css(i.scrollbarXRail, "borderLeftWidth")) +
                u.toInt(a.css(i.scrollbarXRail, "borderRightWidth"))),
              a.css(i.scrollbarXRail, "display", "block"),
              (i.railXMarginWidth =
                u.toInt(a.css(i.scrollbarXRail, "marginLeft")) +
                u.toInt(a.css(i.scrollbarXRail, "marginRight"))),
              a.css(i.scrollbarXRail, "display", ""),
              (i.railXWidth = null),
              (i.railXRatio = null),
              (i.scrollbarYRail = a.appendTo(
                a.e("div", "ps-scrollbar-y-rail"),
                e
              )),
              (i.scrollbarY = a.appendTo(
              ...
              (i.scrollbarYRight = u.toInt(a.css(i.scrollbarYRail, "right"))),
              (i.isScrollbarYUsingRight =
                i.scrollbarYRight == i.scrollbarYRight),
              (i.scrollbarYLeft = i.isScrollbarYUsingRight
                ? null
                : u.toInt(a.css(i.scrollbarYRail, "left"))),
              (i.scrollbarYOuterWidth = i.isRtl
                ? u.outerWidth(i.scrollbarY)
                : null),
              (i.railBorderYWidth =
                u.toInt(a.css(i.scrollbarYRail, "borderTopWidth")) +
                u.toInt(a.css(i.scrollbarYRail, "borderBottomWidth"))),
              a.css(i.scrollbarYRail, "display", "block"),
              (i.railYMarginHeight =
                u.toInt(a.css(i.scrollbarYRail, "marginTop")) +
                u.toInt(a.css(i.scrollbarYRail, "marginBottom"))),
          ...
          t.exports = function (e) {
            ...
            (n.containerWidth = e.clientWidth),
              ...
              e.contains(n.scrollbarXRail) ||
                (0 < (t = r.queryChildren(e, ".ps-scrollbar-x-rail")).length &&
                  t.forEach(function (e) {
                    r.remove(e);
                  }),
                r.appendTo(n.scrollbarXRail, e)),
              e.contains(n.scrollbarYRail) ||
                (0 < (t = r.queryChildren(e, ".ps-scrollbar-y-rail")).length &&
                  t.forEach(function (e) {
                    r.remove(e);
                  }),
        ...
        function (e, t, n) {
          ...
          a.initEvent("ps-scroll-up", !0, !0),
            ...
            (t.exports = function (e, t, n) {
              ...
              "top" === t &&
                n <= 0 &&
                ((e.scrollTop = n = 0), e.dispatchEvent(m)),
                "left" === t &&
                  n <= 0 &&
                  ((e.scrollLeft = n = 0), e.dispatchEvent(h));
              var i = s.get(e);
              "top" === t &&
                n >= i.contentHeight - i.containerHeight &&
                ((e.scrollTop = n = i.contentHeight - i.containerHeight),
                e.dispatchEvent(g)),
                "left" === t &&
                  n >= i.contentWidth - i.containerWidth &&
                  ((e.scrollLeft = n = i.contentWidth - i.containerWidth),
                  e.dispatchEvent(p)),
                r || (r = e.scrollTop),
                o || (o = e.scrollLeft),
                "top" === t && n < r && e.dispatchEvent(a),
                "top" === t && r < n && e.dispatchEvent(l),
                "left" === t && n < o && e.dispatchEvent(c),
                "left" === t && o < n && e.dispatchEvent(u),
                "top" === t && ((e.scrollTop = r = n), e.dispatchEvent(f)),
                "left" === t && ((e.scrollLeft = o = n), e.dispatchEvent(d));
            });
        },
        { "./instances": 18 },
      ],
        ...
        function (e, t, n) {
          ...
          t.exports = function (e) {
            ...
            t &&
              ...
              (t.railXMarginWidth =
                r.toInt(i.css(t.scrollbarXRail, "marginLeft")) +
                r.toInt(i.css(t.scrollbarXRail, "marginRight"))),
              (t.railYMarginHeight =
                r.toInt(i.css(t.scrollbarYRail, "marginTop")) +
                r.toInt(i.css(t.scrollbarYRail, "marginBottom"))),
  ...
  (function () {
    ...
    i.on("click", "#tt-pageContent .tt-toggle-aside", function (e) {
      ...
      o.toggleClass("column-open"),
        i
          .css("top", -t)
          .addClass("no-scroll")
          .append('<div class="modal-filter"></div>');
      var n = $(".modal1-filter").fadeTo("fast", 1);
      return (
        n.length &&
          n.on("click", function () {
      ...
      i.on("click", ".tt-list-avatar .tt-item", function (e) {
        o.removeClass("column-open");
        var t = -1 * parseInt(i.css("top").replace("px", ""), 10);
        return (
          i.removeAttr("style").removeClass("no-scroll").scrollTop(t),
          r.removeAttr("style").scrollTop(t),
          $(".modal1-filter").off().remove(),
          !1
        );
      }),
  ...
  (i = $("#tt-pageContent .js-init-scroll")) && i.perfectScrollbar(),
  (r = $("#tt-pageContent .tt-js-active-btn")).length &&
    r.on("click", ".tt-button-icon", function (e) {
      return (
        $(this).closest(r).find(".tt-button-icon").removeClass("active"),
        $(this).addClass("active"),
        !1
      );
    }),
  (o = window.location.href),
  (s = $("#tt-header .tt-desktop-menu")) &&
    (s.find("li").each(function () {
      var e = $(this).find("a").attr("href");
      -1 !== o.indexOf(e) && $(this).addClass("active");
    }),
    s
      .find("ul li")
      .on("mouseenter", function () {
        ...
        if (($(this).find("a:first").addClass("is-hover"), e.length)) {
          ...
          t - i < n
            ? e.addClass("right-popup")
            : r < n && e.removeClass("right-popup");
        }
      })
  ...
  ($.fn.initMM = function () {
    var i = {
      ...
      init: function (e, t) {
        ...
        null != t && n.parse_arguments(t),
          n.$mobilemenu.parse_mm(i),
          n.$mobilemenu.init_mm(i),
          n.mm_enable_breakpoint && n.$mobilemenu.check_resolution_mm(i),
          e.mm_handler(i);
      },
  ...
  ($.fn.check_resolution_mm = function (e) {
    var t = $(this);
    $(window).resize(function () {
      if (!$("body").hasClass("mm-open") || !t.hasClass("mmitemopen"))
        return !1;
  ...
  ($.fn.parse_mm = function (o) {
    ...
    $(this).empty(),
      s.find("a").each(function () {
        (n = $(this)),
          (e = n.parent().find("ul").first()).length &&
            (t++,
            e
              .prepend("<li></li>")
              .find("li")
              .first()
              .append(n.clone().addClass("mm-original-link")),
            n
              .attr("href", "#mm" + t)
              .attr("data-target", "#mm" + t)
              .addClass("mm-next-level"));
      }),
      s.find("ul").each(function (e) {
        var t, n, i, r;
        (c = !1),
          ...
          0 == e
            ? (l
              ...
              (i = s.find(".mm-closebtn").html()),
              (r = o.mm_close_button),
              (c =
                '<li class="mm-close-parent"><a href="#close" data-target="#close" class="mm-close">' +
                (i = null == i ? r : i) +
                "</a></li>"),
              o.$mobilemenu.hasClass(o.external_con) &&
                l
                  .find("ul")
                  .first()
                  .append('<li id="entrypoint-objects"></li>'))
            : ((t = s.find(".mm-backbtn").html()),
              (n = o.mm_back_button),
              (c =
      ...
      $(this).click(function (e) {
        ...
        return t.hasClass("mm-next-level")
          ? (e.preventDefault(),
            ...
            o.find(i).removeClass("mmhidden"),
            setTimeout(function () {
              o.find(i).scrollTop(0).addClass("mmcurrent").addClass("mmopened");
            }, 0),
            setTimeout(function () {
              n.addClass("mmhidden");
            }, 300),
...
var a,
  ...
  m,
  g,
  v = $(".toggle-mobile-menu"),
  y = $(".tt-desktop-menu"),
  b = $("#mobile-menu");
if (y && v) {
  var _ = y.find("ul").first().children().clone();
  b.find("ul").append(_),
    v.initMM({ enable_breakpoint: !0, mobile_button: !0, breakpoint: 1025 });
}
(a = jQuery)(".modal1").each(function () {
  var e,
    t = a(this);
  ...
  (d = $("#js-settings-btn")).length &&
    ...
    f.on("click", function (e) {
      e.preventDefault(),
        d.removeClass("column-open"),
        u.removeClass("column-open").perfectScrollbar("destroy");
      var t = -1 * parseInt(l.css("top").replace("px", ""), 10);
      return (
        l.removeAttr("style").removeClass("no-scroll").scrollTop(t),
        c.removeAttr("style").scrollTop(t),
        $(".modal1-filter").off().remove(),
        !1
      );
    })),
  (h = $("#tt-pageContent .tt-search-compose .tt-search-results")) &&
    h.perfectScrollbar(),
  (p = $("#tt-header .tt-search")).find(".tt-search-toggle"),
  (m = p.find(".search-results")),
  (g = p.find(".tt-search__input")).length &&
    m.length &&
    (g.on("input", function (e) {
      $(e.target).val() &&
        (m.fadeIn("200"), m.find(".tt-search-scroll").perfectScrollbar());
    }),
    g.blur(function () {
      m.fadeOut("200");
    }));
